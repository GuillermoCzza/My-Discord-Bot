...
const { guiczzaSearchKey } = require('../../config.json');
...
module.exports = {
	...
	async execute(interaction) {
		...
		try {
			const response = await axios.get(`https://www.googleapis.com/customsearch/v1?cx=745c600e8ed73423f&num=${amount}&q=${query}&safe=off&searchType=image&start=${10 * page}&key=${guiczzaSearchKey}`);
